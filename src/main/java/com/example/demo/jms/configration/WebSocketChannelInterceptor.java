...
//            accessor.setUser(user);
            ...
            log.info("User with authKey '{}', ws-id {} session {} make a WebSocket connection and generated ", apiKey, wsId, sessionId);
    ...
    private String readSessionId(StompHeaderAccessor accessor) {
        return ofNullable(accessor.getMessageHeaders().get(SESSION_KEY_HEADER).toString()).get();
